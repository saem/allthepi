...
public class ContactPhoneRecord extends UpdatableRecordImpl<ContactPhoneRecord> implements Record12<Long, UUID, Long, String, Integer, String, Long, String, String, Timestamp, Timestamp, String> {

    private static final long serialVersionUID = -1793663559;
     ...
     */
    @Override
    public Row12<Long, UUID, Long, String, Integer, String, Long, String, String, Timestamp, Timestamp, String> fieldsRow() {
     ...
     */
    @Override
    public Row12<Long, UUID, Long, String, Integer, String, Long, String, String, Timestamp, Timestamp, String> valuesRow() {
     ...
     */
    @Override
    public ContactPhoneRecord value12(String value) {
        setTraceId(value);
        return this;
    }
     ...
     */
    @Override
    public ContactPhoneRecord values(Long value1, UUID value2, Long value3, String value4, Integer value5, String value6, Long value7, String value8, String value9, Timestamp value10, Timestamp value11, String value12) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ContactPhoneRecord(Long no, UUID id, Long contactNo, String type, Integer countryCode, String areaCode, Long number, String extension, String raw, Timestamp createdAt, Timestamp modifiedAt, String traceId) {
        super(ContactPhone.CONTACT_PHONE);
